...
void analyzeMuonMichel(TChain *analysisChain, const Double_t *mu1, const string &outputDir) {
    ...
    TH1F *histMichelSpectrum_Accidental = new TH1F("MichelSpectrum_Accidental",
        "Michel Electron Energy (Accidental);Photoelectrons;Counts/4 p.e.", 200, 0, 800);
    ...
    histMichelSpectrum->SetTitle("Michel Electron Energy Spectrum;Photoelectrons;Counts/4 p.e.");
    ...
    vector< pair<double,double> > fitRanges = {
        make_pair(1.1, 10.0), make_pair(1.5, 10.0), make_pair(2.0, 10.0), make_pair(2.5, 10.0)
    };
