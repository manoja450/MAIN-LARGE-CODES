...
const double SIPM_THRESHOLDS[N_SIPMS] = {300,200,200,200,1000,1000,800,700,500,400};

// Thresholds for PMTs in ADC counts
const double PMT_THRESHOLDS[N_PMTS] = {200,200,200,200,200,200,200,200,200,200,200,200};
...
void analyzeMuonMichel(TChain *analysisChain, const Double_t *mu1, const string &outputDir) {
    ...
    for (size_t i = 0; i < fitRanges.size(); i++) {
        ...
        histDeltaT->SetMarkerStyle(0);
        histDeltaT->SetLineWidth(2);
        histDeltaT->Draw("HIST");
